...
function AppointmentModalFooter(props) {
  ...
  const isPatient = () => {
    return props.role === Role.PATIENT;
  };
      ...
      return (
        AppointmentHelper.isAppointmentAfterTodayDate(
          ...
          <>
            <Button
              onClick={() => {
                let requestPromise = makeCancelAppointmentRequest(
                  props.role,
                  props.modalEvent.id
                );
                requestPromise
            ...
            {props.role === Role.PATIENT && (
              <Button
                onClick={() => {
                  props.onAppointmentDateChange(props.modalEvent.id);
                  props.onHide();
                }}
              >
                Zmień termin wizyty
  ...
  return (
    <>
      {
        appointmentStatusConditionalFooterContentEnum[
