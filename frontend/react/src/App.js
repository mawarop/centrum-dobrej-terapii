          ...
          element={
            ...
            <CreateUpdateUserFormPage
              ...
              makeRequest={(jsonFormData) => {
                return UserService.register(jsonFormData);
              }}
            />
            // </RequireAuth>
          }
        ...
        <Route
          ...
          element={
            <CreateUpdateUserFormPage
              ...
              makeRequest={(jsonFormData, role) => {
                return AdminService.createUser(jsonFormData, role);
              }}
            />
          }
        />
          ...
          element={
            <AdminAddAppointmentPage
              makeRequest={(jsonData) => {
                return AdminService.addAppointment(jsonData);
              }}
            />
          }
        />
